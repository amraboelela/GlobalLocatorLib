    ...
    final class GlobalLocatorLibTests: XCTestCase {
        ...
        func testCodeForRegion() {
            ...
            XCTAssertEqual(globalLocatorLib.codeFor(region: sanJoseRegion), "5Q5N9D")
            ...
            XCTAssertEqual(globalLocatorLib.codeFor(region: johnnyDeppRegion), "9N6B4J")
        ...
        func testSpanForCode() {
            ...
            XCTAssertEqual(span.latitudeDelta, 0.000064373016357, accuracy: 0.0000001)
            XCTAssertEqual(span.longitudeDelta, 0.000064373016357, accuracy: 0.0000001)
        }
