    ...
    final class GlobalLocatorLibTests: XCTestCase {
        ...
        func testSpanForCode() {
            ...
            XCTAssertEqual(span.latitudeDelta, 33.75)
            XCTAssertEqual(span.longitudeDelta, 33.75)
            ...
            XCTAssertEqual(span.latitudeDelta, 0.00102996826171875, accuracy: 0.000001)
            XCTAssertEqual(span.longitudeDelta, 0.00102996826171875, accuracy: 0.000001)
            span = globalLocatorLib.spanFor(code: "54GZZNNH00")
            XCTAssertEqual(span.latitudeDelta, 0.000032186508178, accuracy: 0.0000001)
            XCTAssertEqual(span.longitudeDelta, 0.000032186508178, accuracy: 0.0000001)
        }
        ...
        func testAnnotationForRegion() {
            ...
            XCTAssertEqual(annotation.span, 2467, accuracy: 1)
            ...
            XCTAssertEqual(annotation.span, 2869, accuracy: 1)
